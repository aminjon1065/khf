...
return [
    ...
    */
    ...
    'ssr' => [
        // Disabled: the production target is shared hosting without a persistent Node SSR
        // process. SEO is handled via server-rendered meta tags + sitemap + schema.org
        // (see plan.md decision D-12).
        'enabled' => false,
