...
export default function TouristGroupCreate({
    regions,
    submittedReference,
}: PageProps) {
            ...
            <>
                ...
                <div className="mx-auto max-w-xl rounded-lg border p-8 text-center">
                    ...
                    <h1 className="mt-4 text-2xl font-semibold">
                        {t('tourism.create.success_heading')}
                    </h1>
                    <p className="mt-2 text-muted-foreground">
                        {t('tourism.create.reference_hint')}
                    </p>
                    ...
                    <div className="mt-6 flex justify-center gap-3">
                        ...
                        <Button asChild>
                            <Link href={create({ locale }).url}>
                                {t('tourism.create.new_application_button')}
                            </Link>
                        </Button>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="mt-6 space-y-4">
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div className="space-y-2">
                            ...
                            />
                            <InputError
                                id="leader_name-error"
                                message={errors.leader_name}
                            />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="leader_phone">
                                {t('tourism.form.leader_phone')}
                            </Label>
                            <Input
                                id="leader_phone"
                                value={form.data.leader_phone}
                                onChange={(e) =>
                        ...
                        <div className="space-y-2">
                            ...
                            <InputError
                                id="participants_count-error"
                                message={errors.participants_count}
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            aria-describedby={
                                errors.route ? 'route-error' : undefined
                            }
                        />
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            aria-describedby={
                                errors.equipment ? 'equipment-error' : undefined
                            }
                        />
                        <InputError
                            id="equipment-error"
