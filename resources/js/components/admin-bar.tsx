...
import { create as createPage, edit as editPage } from '@/routes/admin/pages';
import { create as createPost, edit as editPost } from '@/routes/admin/posts';
